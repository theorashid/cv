...
python, R, Stan, Julia, shell/ssh, git, SQL, FastAPI, LLM, NLP, LangChain, jax, PyTorch, mlflow, serverless functions, CI/CD, high performance computing, data visualisation, D3.js, Markdown, Quarto, LaTeX, html, CAD
