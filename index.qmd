...
`2024-`
__Data Scientist, Faculty__, London
...
`2023`
Researcher, __University of Oxford__ and __Columbia University__
...
Bayesian modelling, machine learning, forecasting, spatiotemporal statistics, probabilistic programming, open source software

### Computational

python, R, Stan, Julia, shell/ssh, git, SQL, FastAPI, LLM, NLP, LangChain, jax, CI/CD, high performance computing, data visualisation, D3.js, Markdown, Quarto, LaTeX, html, CAD
