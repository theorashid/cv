  ...
  html:
    ...
    - text: |
        ...
        <div align="left", id="webaddress">
            <a href="mailto:theoaorashid@proton.me">theoaorashid@proton.me</a>
...
`2024-`
__Applied Scientist, Amazon__, Seattle

- Building forecasting models and the MLOps infrastructure for scaling.
- Alien with extraordinary ability (O1) visa.

## Experience

`2024`
Data Scientist, __Faculty__, London

- Building an API and LLM application which allows Faculty staff to ask questions about previous internal projects.

`2023-24`
__Freelance__ Data Scientist

- Modelling soil carbon stock using spatial machine learning methods at [Loamin](https://www.loamin.com/).
- Implementing approximate Bayesian inference algorithms, contract with [PyMC labs](https://www.pymc-labs.com/).
- Modelling food insecurity in [Seth Flaxman's](https://sethrf.com) group at the University of Oxford in collaboration with the UN World Food Programme.
- Building scalable Bayesian environmental health models in [Robbie Parks'](https://sparklabnyc.github.io/site/home.html) lab at Columbia University.

`2022`
Applied Scientist, __Amazon__, Seattle
...
`2026`
Ngoka, N.D., Fabisiak, A., Fratantoni, J., Alla, S., Cook, K., and __Rashid, T.__. (2026). [Build AI workflows on Amazon EKS with Union.ai and Flyte](https://aws.amazon.com/blogs/machine-learning/build-ai-workflows-on-amazon-eks-with-union-ai-and-flyte/). _AWS Artificial Intelligence Blog_.

`2024`
__Rashid, T.__, Bennett, J.E. _et al._ (2024). [Mortality from leading cancers in districts of England from 2002 to 2019: a population-based, spatiotemporal study](https://doi.org/10.1016/S1470-2045%2823%2900530-2). _The Lancet Oncology_, 25, 86-98.
...
`2024`
Improving Grocery Forecasting with a Bayesian Multivariate Structural Time Series Model, __Amazon Consumer Science Summit__
...
`2025`
Google Summer of Code Mentor, __Integrated Nested Laplace Approximation__, PyMC
...
Teaching Assistant, __Advanced Regression__ in the Epidemiology MSc, Imperial College London

Teaching Assistant, __Statistics for Public Health__ in the MPH, Imperial College London

<!-- ## Peer Review

_Journal of Open Source Software_ article. [GPJax: A Gaussian Process Framework in JAX](https://joss.theoj.org/papers/10.21105/joss.04455).

_Journal of Machine Learning Research_ (Gaussian process [paper](https://arxiv.org/abs/2404.12478) on behalf of Seth Flaxman). 

Andrew Gelman's, _MCMC Handbook: Latent Gaussian Models and Computation for Large Spatial Data_ (on behalf of Seth Flaxman). 

_The Case for Degrowth_, review [published](https://journalhss.com/wp-content/uploads/Rashid_10.192042021rcnt7.pdf) in the _Journal of Health and Social Sciences_. -->

## Skills

### Statistical

Bayesian modelling, machine learning, forecasting, spatiotemporal statistics, probabilistic programming, Gaussian processes, [open source software](https://github.com/theorashid)

### Computational

python, R, Stan, Julia, shell/ssh, git, SQL, LLM, NLP, LangChain, xarray, numba, jax, PyTorch, Airflow, MLflow, Kubernetes, Ray, serverless functions, AWS CDK (TypeScript), FastAPI, CI/CD, high performance computing, data visualisation, D3.js, Markdown, Quarto, LaTeX, html, CAD
